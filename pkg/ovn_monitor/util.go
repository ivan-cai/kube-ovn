...
func (e *Exporter) getOvnStatus() (bool, error) {
	...
	for _, component := range components {
		...
		log.Debugf("%s: getOvnStatus() calls GetProcessInfo(%s)", e.Client.System.ID, component)
		if err != nil {
		...
		log.Debugf("%s: getOvnStatus() completed GetProcessInfo(%s)", e.Client.System.ID, component)
	}
